      ...
      <div className="animate-gradient relative mx-auto max-w-7xl overflow-hidden rounded-[12px] border border-border bg-[linear-gradient(110deg,#17211a,#0f2e1d_42%,#168a45_72%,#1aa858)] px-6 py-9 text-white shadow-[0_24px_70px_rgba(23,33,26,0.18)] sm:px-10">
        ...
        <div className="relative z-10 grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            <a href="https://github.com/moo-tion" target="_blank" rel="noopener noreferrer" className="cta-primary-glow inline-flex items-center justify-center gap-2 rounded-full bg-white px-6 py-3.5 text-sm font-black text-text-primary shadow-[0_16px_36px_rgba(255,255,255,0.18)] transition duration-200">
